 ...
 */
public class IA57 extends NecesitaHechizo {

    public IA57(Pelea fight, Peleador fighter, byte count) {
    ...
    public void apply() {
        if (!this.stop && this.fighter.canPlay() && this.count > 0) {
            ...
            Peleador A = Funcion.getInstance().getNearestAminbrcasemax(this.fight, this.fighter, 1, maxPo + 1);// pomax +1;
