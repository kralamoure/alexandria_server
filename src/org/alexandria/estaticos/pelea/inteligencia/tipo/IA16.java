 ...
 */
public class IA16 extends InteligenciaAbstracta {

    public IA16(Pelea fight, Peleador fighter, byte count) {
        ...
        if (this.count > 0 && this.fighter.canPlay() && !this.stop) {
            ...
            if (cellId != -1) {
                if (this.fight.canCastSpell1(this.fighter, spellStats, this.fighter.getCell(), cellId)) {
                    ...
                    if (!Funcion.getInstance().moveNearIfPossible(this.fight, this.fighter, target))
